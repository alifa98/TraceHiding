...
python experiment_scripts/07_2_mia_xgboost.py --model LSTM --dataset Ho_Foursquare_NYC --scenario user --method bad-t --sampleSize 1 --batchSize 20 & 
python experiment_scripts/07_2_mia_xgboost.py --model LSTM --dataset Ho_Foursquare_NYC --scenario user --method bad-t --sampleSize 5 --batchSize 20 & 
python experiment_scripts/07_2_mia_xgboost.py --model LSTM --dataset Ho_Foursquare_NYC --scenario user --method bad-t --sampleSize 10 --batchSize 20 & 
python experiment_scripts/07_2_mia_xgboost.py --model LSTM --dataset Ho_Foursquare_NYC --scenario user --method bad-t --sampleSize 20 --batchSize 20
