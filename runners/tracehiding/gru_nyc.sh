...
python experiment_scripts/05_1_our_method.py --model GRU --dataset HO_NYC_Res9 --scenario user --biased entropy_max --sampleSize 2 --batchSize 20  --importance uuniqe &
python experiment_scripts/05_1_our_method.py --model GRU --dataset HO_NYC_Res9 --scenario user --biased entropy_max --sampleSize 11 --batchSize 20  --importance uuniqe &
python experiment_scripts/05_1_our_method.py --model GRU --dataset HO_NYC_Res9 --scenario user --biased entropy_max --sampleSize 23 --batchSize 20  --importance uuniqe &
python experiment_scripts/05_1_our_method.py --model GRU --dataset HO_NYC_Res9 --scenario user --biased entropy_max --sampleSize 46 --batchSize 20  --importance  uuniqe &
